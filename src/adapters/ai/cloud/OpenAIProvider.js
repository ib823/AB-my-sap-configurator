// src/adapters/ai/cloud/OpenAIProvider
...
export class OpenAIProvider implements AIProvider {
  ...
  private buildEstimationPrompt(request: EstimationRequest) {
    return `
...
Consider ABeam's methodology and Malaysian market specifics in your estimation.
  ...
  private parseEstimationResult(result, request: EstimationRequest): EstimationResult {
    return {
