...
export class LocalProvider implements AIProvider {
  ...
  private getSizeMultiplier(size | undefined) {
    switch (size) {
      case 'sme': return 0.8;
  ...
  private getIndustryMultiplier(industry | undefined) {
    switch (industry) {
  ...
  private getRiskFactors(packageId, profile)[] {
    const risks = [];
  ...
  private generateRecommendations(request: EstimationRequest, breakdown[])[] {
  ...
  private generateScenarios(baseEffort)[] {
    return [
      {
